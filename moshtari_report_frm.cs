...
{
    public partial class moshtari_report_frm : Form
    {
        public moshtari_report_frm()
        {
            InitializeComponent();
        }
        ...
        private void moshtari_report_frm_Load(object sender, EventArgs e)
        {
        ...
        {
            DataTable dt = moshTableTableAdapter.GetMoshName(txt_search_name.Text);
            if (dt.Rows.Count == 0)
            {
